...
namespace SchoolERP.Net.Services.Clients
{
    ...
    {
        Task<ApiResponse<List<RoomTypeViewModel>>> GetAllRoomTypesAsync(bool includeDeleted = false, int? sessionId = null);
        ...
        // Hostel
        Task<ApiResponse<List<HostelViewModel>>> GetAllHostelsAsync(bool includeDeleted = false, int? sessionId = null);
