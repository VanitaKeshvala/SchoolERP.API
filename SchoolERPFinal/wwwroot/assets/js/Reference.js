...
// ========================================
const FILTER_KEY = 'appliedFilters_reference';
let appliedFilters = {};
try {
...
async function editSelected() {
    ...
    try {
        ...
        if (window.selectedPurposesId) {
            location.href = `/Reference/AddReference/${window.selectedPurposesId}`;
        }
...
async function saveRecord() {
    ...
    const r = await fetch('/Reference/SaveReference', {
        method: 'POST',
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    url: '/Reference/ToggleReferenceStatus',
                    type: 'POST',
                    contentType: 'application/json',
