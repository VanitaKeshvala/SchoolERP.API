...
async function editSelected() {
    ...
    try {
        ...
        if (window.selectedClassId) {
            location.href = `/Publisher/Add/${window.selectedClassId}`;
        }
...
async function saveItem() {
    ...
    const name = document.getElementById('txtPublisherName').value.trim();
    if (!name) {
        IV.setFieldError('txtPublisherName', 'errtxtPublisherName', 'Publisher name is required.');
        return;
    }
    ...
    try {
        ...
        const r = await fetch('/Publisher/SavePublisher', {
            method: 'POST',
        ...
        if (res.success) {
            Swal.fire({
                icon: 'success',
                title: 'Saved!',
                text: res.message || 'publisher has been added successfully.',
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: res.message || 'Failed to save publisher.',
                confirmButtonText: 'OK',
