...
async function editSelected() {
    ...
    try {
        ...
        if (window.selectedClassId) {
            location.href = `/LibraryDocumentType/Add/${window.selectedClassId}`;
        }
...
async function deleteSelected() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '/LibraryDocumentType/DeleteLibraryDocumentType',
                type: 'POST',
...
async function saveItem() {
    ...
    const name = document.getElementById('txtDocumentName').value.trim();
    if (!name) {
        IV.setFieldError('txtDocumentName', 'errtxtDocumentName', 'Document Name is required.');
        return;
    }
    ...
    try {
        ...
        const r = await fetch('/LibraryDocumentType/SaveLibraryDocumentType', {
            method: 'POST',
        ...
        if (res.success) {
            Swal.fire({
                ...
                window.location.href = '/LibraryDocumentType/Index';
            });
        } else {
            Swal.fire({
                icon: 'error',
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    url: '/LibraryDocumentType/ToggleLibraryDocumentType',
                    type: 'POST',
                    contentType: 'application/json',
